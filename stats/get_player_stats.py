...
def get_player_stats(player_id, season_id):
    stats = {
        ...
        "fg_percent": retrieve_and_calculate_data('get_total_field_goals_and_attempts', 'fg_percent', player_id, season_id),
        "three_point_percent": retrieve_and_calculate_data('get_total_three_pointers_and_attempts', 'three_point_percent', player_id, season_id),
        "ft_percent": retrieve_and_calculate_data('get_total_free_throws_and_attempts', 'ft_percent', player_id, season_id),
    }
    return stats
